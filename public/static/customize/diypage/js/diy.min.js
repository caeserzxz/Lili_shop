define(['jquery.ui'], function (ui) {
    ...
    modal.initNavs = function () {
        ...
        var navgroup = {
            ...
            1: ['search', 'fixedsearch', 'notice', 'goods', 'tabbar'],
    ...
    modal.getNavs = function () {
        modal.navs = {
            notice: {
                name: '公告',
                params: {
                    'iconurl': '/static/customize/images/default/hotdot.png',
                    'noticedata': '0',
                    'speed': '4',
                    'noticenum': '5'
                },
            ...
            banner: {
                ...
                data: {
                    C0123456789101: {
                        imgurl: '/static/customize/images/default/banner-1.jpg',
                        linkurl: '',
                    },
                    C0123456789102: {
                        imgurl: '/static/customize/images/default/banner-2.jpg',
                        linkurl: '',
                    }
                }
            },
            ...
            menu: {
                ...
                data: {
                    C0123456789101: {
                        imgurl: '/static/customize/images/default/icon-1.png',
                        linkurl: '',
                        text: '按钮文字1',
                        color: '#666666'
                    },
                    C0123456789102: {
                        imgurl: '/static/customize/images/default/icon-2.png',
                        linkurl: '',
                        text: '按钮文字2',
                        color: '#666666'
                    },
                    C0123456789103: {
                        imgurl: '/static/customize/images/default/icon-3.png',
                        linkurl: '',
                        text: '按钮文字3',
                        color: '#666666'
                    },
                    C0123456789104: {
                        imgurl: '/static/customize/images/default/icon-4.png',
                        linkurl: '',
                        text: '按钮文字4',
                        color: '#666666'
                    }
            ...
            picturew: {
                ...
                data: {
                    C0123456789101: {
                        imgurl: '/static/customize/images/default/cube-1.jpg',
                        linkurl: '',
                    },
                    C0123456789102: {
                        imgurl: '/static/customize/images/default/cube-2.jpg',
                        linkurl: '',
                    },
                    C0123456789103: {
                        imgurl: '/static/customize/images/default/cube-3.jpg',
                        linkurl: '',
                    },
                    C0123456789104: {
                        imgurl: '/static/customize/images/default/cube-4.jpg',
                        linkurl: '',
                    }
                }
            },
            pictures: {
                ...
                data: {
                    C0123456789101: {
                        imgurl: '/static/customize/images/default/goods-1.jpg',
                        linkurl: '',
                        title: '这里是上标题',
                        text: '这里是下标题'
                    },
                    C0123456789102: {
                        imgurl: '/static/customize/images/default/goods-2.jpg',
                        linkurl: '',
                        title: '这里是上标题',
                        text: '这里是下标题'
                    },
                    C0123456789103: {
                        imgurl: '/static/customize/images/default/goods-4.jpg',
                        linkurl: '',
                        title: '这里是上标题',
                        text: '这里是下标题'
                    }
            ...
            goods: {
                ...
                data: {
                    C0123456789101: {
                        thumb: '/static/customize/images/default/goods-1.jpg',
                        price: '20.00',
                        productprice: '99.00',
                        title: '这里是商品标题',
                        sales: '0',
                    ...
                    C0123456789102: {
                        thumb: '/static/customize/images/default/goods-2.jpg',
                        price: '20.00',
                        productprice: '99.00',
                        title: '这里是商品标题',
                        sales: '0',
                    ...
                    C0123456789103: {
                        thumb: '/static/customize/images/default/goods-3.jpg',
                        price: '20.00',
                        productprice: '99.00',
                        sales: '0',
                        title: '这里是商品标题',
                    ...
                    C0123456789104: {
                        thumb: '/static/customize/images/default/goods-4.jpg',
                        price: '20.00',
                        productprice: '99.00',
                        sales: '0',
                        title: '这里是商品标题',
            ...
            detail_shop: {
                ...
                max: 1,
                params: {
                    shoplogo: "/customize/static/images/designer.jpg",
                    shopname: "",
                    shopdesc: "",
                    hidenum: 0,
                    leftnavtext: "全部商品",
            ...
            seckillgroup: {
                ...
                name: "秒杀组",
                params: {
                    iconurl: '/static/customize/images/default/seckill.png',
                    hideborder: 0,
                    tag: ''
                },
                style: {
            ...
            exchange_input: {
                ...
                params: {
                    ...
                    exbtntext: '兑换',
                    exbtn2text: '已兑换',
                    crediticon: '/static/customize/images/default/icon_credit.png',
                    moneyicon: '/static/customize/images/default/icon_money.png',
                    couponicon: '/static/customize/images/default/icon_coupon.png',
                    redbagicon: '/static/customize/images/default/icon_redbag.png',
                    goodsicon: '/static/customize/images/default/icon_goods.png'
                },
                style: {
                    titlecolor: '#444444',
                    btncolor: '#ffffff',
    ...
    modal.initTilteBg = function () {
        ...
        $('#page').css('background-image', 'url("/static/customize/diypage/images/' + imgsrc + '.png")')
    };
    ...
    modal.initTpl = function () {
        tpl.helper("imgsrc", function (src) {
            ...
            if (src.indexOf('http://') == 0 || src.indexOf('https://') == 0 || src.indexOf('/static/customize/') == 0 || src.indexOf('/upload') == 0) {
                return src
